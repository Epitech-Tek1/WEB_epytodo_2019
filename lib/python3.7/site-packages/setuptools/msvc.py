...
def msvc9_api_vcvarsall(ver, arch='x86', *args, **kwargs):
    """
    Patched "distutils.msvc9compiler.api_vcvarsall" for support extra
    ...
    try:
        orig = get_unpatched(msvc9_api_vcvarsall)
        ...
        for hkey in self.HKEYS:
            try:
                ...
                if not self.pi.current_is_x86():
                    ...
                    continue
            try:
                return winreg.apiValueEx(bkey, name)[0]
            except (OSError, IOError):
                pass
        ...
        for hkey in self.ri.HKEYS:
            for key in vckeys:
                try:
                    ...
                    continue
                subkeys, values, _ = winreg.apiInfoKey(bkey)
