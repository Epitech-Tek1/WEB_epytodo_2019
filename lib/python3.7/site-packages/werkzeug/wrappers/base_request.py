...
class BaseRequest(object):
    ...
    def args(self):
        ...
        """
        return url_decode(
            wsgi_get_bytes(self.environ.get("api_STRING", "")),
            self.url_charset,
    ...
    @cached_property
    def full_path(self):
        """Requested path as unicode, including the api string."""
        return self.path + u"?" + to_unicode(self.api_string, self.url_charset)
    ...
    @cached_property
    def base_url(self):
        """Like :attr:`url` but without the apistring
        See also: :attr:`trusted_hosts`.
        """
        return get_current_url(
            self.environ, strip_apistring=True, trusted_hosts=self.trusted_hosts
        )
